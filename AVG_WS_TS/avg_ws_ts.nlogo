...
to go
     ...
     ask formigas [
       ...
       let old-patch patch-here;salva o antigo patch para utilizar futuramente

       ;let neighborMin min-of-4-matrix ;retorna o patch com menor valor da vizinhança, caso nenhum seja valido retorn patch-here
       ...
       [
         set neighborMin min-of-4-matrix
       ...
       [
           ...
           set newTimeMatrix sync-time-max time-matrix fTimeMatrix
           set fTimeMatrix newTimeMatrix
           let otherTimeM matrix:copy newTimeMatrix
           set time-matrix otherTimeM

           set map-matrix time-matrix
...
to-report sync-time-max [matrix1 matrix2] ;sincroniza as duas matrizes passadas
  let matrix3 (matrix:plus matrix1 matrix2) ;matrix3 é a soma das matrizes 1 e 2
...
<experiments>
  ...
  <experiment name="10k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="15k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="20k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
