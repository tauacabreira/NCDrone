...
to go
     ...
     ask formigas [
       ...
       let neighborMin min-of-4-neighbor ;retorna o patch com menor valor da vizinhança
      ...
      [
        if( [u-value] of patch-left-and-ahead 90 -1 = menor)
          [set turn-side turn-side + 1
            ...
            if([visita-anterior] of patch-left-and-ahead -90 1) < ([visita-anterior] of patch-left-and-ahead 90 1)
            [
...
<experiments>
  ...
  <experiment name="nc10k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="nc15k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="nc20k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
